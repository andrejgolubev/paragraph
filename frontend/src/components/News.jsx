  ...
  return (
    <div className={`news-container ${darkTheme ? "dark" : ""}`}>
      <a href={url} target="_blank">
        <img src={darkTheme ? telegramIconDark : telegramIcon} alt="telegram" />
      </a>
      <p>
        Подписывайтесь на
        <a
          className={`news-container__link ${darkTheme ? "dark" : ""}`}
          href={url}
          target="_blank"
        >
          {" "}
        ...
        в Telegram! Любая активность мотивирует меня продолжать разработку.
      </p>
    </div>
  )
}
