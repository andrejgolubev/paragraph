...
db_url = settings.db.url if not settings.app.dev else settings.db.test_url
...
# using template from https://alembic.sqlalchemy.org/en/latest/cookbook.html#asyncio
